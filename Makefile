...
define Package/mentohust1/description
...
define Package/mentohust1/conffiles
/etc/mentohust1.conf
endef
...
define Package/mentohust1/install
	$(INSTALL_DIR) $(1)/usr/sbin
	$(INSTALL_BIN) $(PKG_BUILD_DIR)/mentohust1 $(1)/usr/sbin/
	$(INSTALL_DIR) $(1)/etc
	$(INSTALL_CONF) $(PKG_BUILD_DIR)/mentohust1.conf $(1)/etc/mentohust1.conf
