...
static const char *PACKAGE_BUGREPORT = "http://code.google.com/p/mentohust1/issues/list";
#endif
...
static const char *CFG_FILE = "/etc/mentohust1.conf";	/* 配置文件 */
static const char *LOG_FILE = "/tmp/mentohust1.log";	/* 日志文件 */
static const char *LOCK_FILE = "/tmp/mentohust1.pid";	/* 锁文件 */
